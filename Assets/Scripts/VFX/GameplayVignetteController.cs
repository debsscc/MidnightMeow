...
public class GameplayVignetteController : MonoBehaviour
{
    ...
    private const float MaxLowHealthVignette = 0.36f;
    private const float MaxCriticalVignetteBoost = 0.1f;
    private const float MaxSaturationDrop = -26f;
    private const float MaxContrastBoost = 12f;
    private const float MaxChromaticAberration = 0.12f;
    ...
    private void ApplyLowHealthFrame()
    {
        ...
        Color targetColorFilter = Color.Lerp(Color.white, LowHealthColorFilter, _smoothedStress);
        float targetSaturation = _smoothedStress * MaxSaturationDrop;
        float targetContrast = _smoothedStress * MaxContrastBoost;
        float targetChromatic = _smoothedStress * MaxChromaticAberration;
        float targetSmoothness = Mathf.Lerp(0.42f, 0.54f, _smoothedStress);
